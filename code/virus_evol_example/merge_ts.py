...
def main(args):
    ...
    argp.add_argument('-i', '--input_dir', type = str, help = 'Path to directory containing tree sequences to be merged', required=True)
    ...
    tslist = [tskit.load(x) for x in input_dir_files]
